// void callbackANTIGO(char* topic, byte* payload, unsigned int length) {
...
// void controlaPinoANTIGO(int pino, const char* comando) {
...
// void processaIRANTIGO(String topicStr, byte* payload, unsigned int length) {
...
// void processaComandoANTIGO(byte* payload) {
//   if ((char)payload[0] == 'a') {
//     int ops = payload[1] - '0';
//     feedback(ops);
//   }
