...
//   p_mqtt_port = new WiFiManagerParameter("mqtt_port", "Porta MQTT", mqtt_port_str, sizeof(mqtt_port_str));
...
//   // SELECT MQTT ENABLE
//   const char* mqttEnabledSelected = "selected";
//   const char* mqttDisabledSelected = "";

//   if (strcmp(mqtt_enabled_buf, "no") == 0) {
//     mqttEnabledSelected = "";
//     mqttDisabledSelected = "selected";
//   }

//   static char mqttSelectHtml[512];
//   snprintf(mqttSelectHtml, sizeof(mqttSelectHtml),
//            "<br><label for='mqtt_enabled'>MQTT</label><br>"
//            "<select id='mqtt_enabled' name='mqtt_enabled' style='width:100%%;padding:6px;border-radius:6px;"
...
//            "</select>",
//            mqttEnabledSelected, mqttDisabledSelected);

//   p_mqtt_enabled = new WiFiManagerParameter(mqttSelectHtml);
...
//   String mqtt_enabled_value = WiFiManager::getInstance()->server->arg("mqtt_enabled");

//   if (mqtt_enabled_value == "yes") {
//     strlcpy(mqtt_enabled_buf, "yes", sizeof(mqtt_enabled_buf));
//   } else {
//     strlcpy(mqtt_enabled_buf, "no", sizeof(mqtt_enabled_buf));
//   }
