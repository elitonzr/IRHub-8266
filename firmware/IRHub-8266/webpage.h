...
<body>
  ...
  <div class="grid">
    ...
    <div class="card">
      ...
      <div class="item"> Status: <span id="sensorAHT10Status" class="status offline">offline</span></div>
    </div>
      ...
      fetch("/ir_receptor")
        ...
        .then((data) => {
          ...
          if (
            ...
            !data.ir_receptor.receptor.toLowerCase().includes("off")
          ) {
          ...
          const payload =
            new Date().toLocaleTimeString() + " - " + rawPayload;
          ...
          irText.innerText =
            data.ir_receptor.protocolo + " | DEC " + data.ir_receptor.dec + " | HEX " + data.ir_receptor.hex;
        })
        .catch(() => {
          const irStatus = document.getElementById("irStatus");
          const irText = document.getElementById("irText");
